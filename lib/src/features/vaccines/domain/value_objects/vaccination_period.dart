...
const List<VaccinationPeriod> standardVaccinationPeriods = <VaccinationPeriod>[
  ...
  VaccinationPeriod(id: '9ヶ月', label: '9ヶ月', order: 9),
  VaccinationPeriod(id: '1才', label: '1才', order: 10),
  VaccinationPeriod(id: '1才4ヶ月', label: '1才4ヶ月', order: 11),
  VaccinationPeriod(id: '1才6ヶ月', label: '1才6ヶ月', order: 12),
