...
Future<bool?> showConcurrentVaccinesDeleteDialog({
  ...
  return showDialog<bool>(
    context: context,
    builder: (_) => _ConcurrentVaccinesDeleteDialog(
...
class _ConcurrentVaccinesDeleteDialog extends ConsumerWidget {
  const _ConcurrentVaccinesDeleteDialog({
