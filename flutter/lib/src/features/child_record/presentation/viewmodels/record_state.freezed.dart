...
mixin _$RecordUiEvent {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, message, openSlot, openEditor);

  @override
  String toString() {
    return 'RecordUiEvent(message: $message, openSlot: $openSlot, openEditor: $openEditor)';
  }
}
...
extension RecordUiEventPatterns on RecordUiEvent {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? message, RecordSlotRequest? openSlot,
            RecordEditorRequest? openEditor)?
        $default, {
    required TResult orElse(),
  }) {
...
class _RecordUiEvent implements RecordUiEvent {
  const _RecordUiEvent({this.message, this.openSlot, this.openEditor});
